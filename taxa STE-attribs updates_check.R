...
write.csv(missing, "missing_from_BCG_05162024.csv")
...
# write.csv(missing_coarse_attribs, "missing_coarse_attribs_05162024.csv")
...
setwd("C:/Users/esosik/King County/DNRP - Science TCA Unit - Bug Monitoring/PSSB issues/STE_attrib_updates")
OTU_correct_hier[OTU_correct_hier=="ZZZ"]<-""
write.csv(OTU_correct_hier, "updated_master_list_draft_check_05162024.csv")
