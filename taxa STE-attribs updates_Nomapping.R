...
test<-OTU_correct_hier[,c(3:24, 2)]
for (i in 1:ncol(test)){
  ...
  names(attribs)<-str_replace(names(attribs), "Taxon.1", "Taxon")
  names(exlude2)<-str_replace(names(exlude2), "Taxon.1", "Taxon")
...
OTU_correct_hier[which(is.na(OTU_correct_hier$Coarse_STE)),"Coarse_STE"]<-OTU_correct_hier[which(is.na(OTU_correct_hier$Coarse_STE)),"Taxon"]
...
OTU_correct_hier[which(is.na(OTU_correct_hier$Medium_STE)),"Medium_STE"]<-OTU_correct_hier[which(is.na(OTU_correct_hier$Medium_STE)),"Taxon"]
...
OTU_correct_hier[which(is.na(OTU_correct_hier$Fine_STE)),"Fine_STE"]<-OTU_correct_hier[which(is.na(OTU_correct_hier$Fine_STE)),"Taxon"]
...
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(3:24, 27, 28)]
...
write.csv(missing_coarse_attribs, "missing_coarse_attribs_05102024Nomapping.csv")
...
attribs2<-data.frame(Taxon.Name=character(), Predator=character(), Long.Lived=character(), Tolerant=character(), Intolerant=character(), Clinger=character())
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(3:24, 29, 30)]
...
write.csv(missing_medium_attribs, "missing_medium_attribs_05102024NoMapping.csv")
...
attribs2<-data.frame(Taxon.Name=character(), Predator=character(), Long.Lived=character(), Tolerant=character(), Intolerant=character(), Clinger=character())
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(3:24, 31, 32)]
...
write.csv(missing_Fine_attribs, "missing_Fine_attribs_05102024NoMapping.csv")
...
write.csv(att_no_match, "attributes_wo_match_05102024NoMapping.csv")
################## add HBI attributes############
...
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(6:27, 3, 30)]
...
missing_coarse_attribs<-test
write.csv(missing_coarse_attribs, "missing_coarse_hbi_05102024NoMapping.csv")
coarse_attributes<-attribs2
coarse_attributes<-unique(coarse_attributes)
...
attribs2<-data.frame(Taxon.Name=character(), HBI=numeric())
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(6:27, 2, 31)]
...
missing_Medium_attribs<-test
write.csv(missing_Medium_attribs, "missing_medium_hbi_05102024NoMapping.csv")
Medium_attributes<-attribs2
Medium_attributes<-unique(Medium_attributes)
...
attribs2<-data.frame(Taxon.Name=character(), HBI=numeric())
names(OTU_correct_hier)
test<-OTU_correct_hier[,c(6:27, 1, 32)]
...
missing_Fine_attribs<-test
write.csv(missing_Fine_attribs, "missing_fine_hbi_05102024NoMapping.csv")
Fine_attributes<-attribs2
Fine_attributes<-unique(Fine_attributes)
...
write.csv(hbi_no_match, "HBIT_wo_match_05102024NoMapping.csv")
################## add MTI attributes############
...
missing_coarse_attribs<-test
write.csv(missing_coarse_attribs, "missing_coarse_MTI_05102024NoMapping.csv")
coarse_attributes<-attribs2
coarse_attributes<-unique(coarse_attributes)
...
missing_Medium_attribs<-test
write.csv(missing_Medium_attribs, "missing_medium_MTI_05102024NoMapping.csv")
Medium_attributes<-attribs2
Medium_attributes<-unique(Medium_attributes)
...
missing_Fine_attribs<-test
write.csv(missing_Fine_attribs, "missing_fine_MTI_05102024NoMapping.csv")
Fine_attributes<-attribs2
Fine_attributes<-unique(Fine_attributes)
...
write.csv(mti_no_match, "MTI_wo_match_05102024NoMapping.csv")
################## add FSBI attributes############
...
missing_coarse_attribs<-test
write.csv(missing_coarse_attribs, "missing_coarse_FSBI_05102024NoMapping.csv")
coarse_attributes<-attribs2
coarse_attributes<-unique(coarse_attributes)
...
missing_Medium_attribs<-test
write.csv(missing_Medium_attribs, "missing_medium_FSBI_05102024NoMapping.csv")
Medium_attributes<-attribs2
Medium_attributes<-unique(Medium_attributes)
...
missing_Fine_attribs<-test
write.csv(missing_Fine_attribs, "missing_fine_FSBI_05102024NoMapping.csv")
Fine_attributes<-attribs2
Fine_attributes<-unique(Fine_attributes)
...
write.csv(fsbi_no_match, "FSBI_wo_match_05102024NoMapping.csv")
################## add FSBI attributes############
...
missing_coarse_attribs<-test
write.csv(missing_coarse_attribs, "missing_coarse_Relyea_FSBI_05102024NoMapping.csv")
coarse_attributes<-attribs2
coarse_attributes<-unique(coarse_attributes)
...
missing_Medium_attribs<-test
write.csv(missing_Medium_attribs, "missing_medium_Relyea_FSBI_05102024NoMapping.csv")
Medium_attributes<-attribs2
Medium_attributes<-unique(Medium_attributes)
...
missing_Fine_attribs<-test
write.csv(missing_Fine_attribs, "missing_fine_Relyea_FSBI_05102024NoMapping.csv")
Fine_attributes<-attribs2
Fine_attributes<-unique(Fine_attributes)
...
write.csv(fsbi_no_match2, "Relyea_FSBI_wo_match_05102024NoMapping.csv")
...
write.csv(fsbi_no_match[!fsbi_no_match$Taxon.Name %in% fsbi_no_match2$Taxon,], "PSSB_FSBI_not_in_Relyea_05102024NoMapping.csv")

fsbi_no_match2[!fsbi_no_match2$Taxon %in% fsbi_no_match$Taxon.Name& fsbi_no_match2$FSBI_Score!=0,]
write.csv(fsbi_no_match2[!fsbi_no_match2$Taxon %in% fsbi_no_match$Taxon.Name& fsbi_no_match2$FSBI_Score!=0,], "Relyea_FSBI_not_in_PSSB_05102024NoMapping.csv")

getwd()
setwd("C:/Users/esosik/King County/DNRP - Science TCA Unit - Bug Monitoring/PSSB issues/STE_attrib_updates")
OTU_correct_hier[OTU_correct_hier=="ZZZ"]<-""
write.csv(OTU_correct_hier, "updated_master_list_draft_05102024NoMapping.csv")
